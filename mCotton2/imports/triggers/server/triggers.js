...
Meteor.startup(function () {
    ...
    if (enabled) {
        startRule(Rules.rule_1);
        startRule(Rules.rule_2);
        startRule(Rules.rule_3);
        startRule(Rules.rule_4);
        startRule(Rules.rule_5);
        startRule(Rules.rule_6);
        startRule(Rules.rule_7);
